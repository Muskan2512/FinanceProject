...
<div className='text-white  w-screen  flex flex-col items-center justify-center  navbar-color '>
<p className=' text-3xl text-center text-gray font-[Inter] font-semibold'>About Us</p>
  <p className='text-center  w-[80%] mx-auto  leading-[2rem] font-[400] '>Welcome to our Game, an interactive and engaging financial literacy game designed to help users learn essential money management skills in a fun way!
...
<div className='h-20 w-screen bg-[#161D29] flex flex-col justify-center items-center gap-5 pad navbar-color border-t-2 border-[#423d3d]'>
Made with ❤️ for PRAGYAN 2025
</div>
