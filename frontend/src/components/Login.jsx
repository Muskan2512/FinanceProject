...
const Login = () => {
 ...
 <div className='w-11/12 text-white h-fit min-h-[100vh] flex lg:flex-row justify-center md:gap-[10%] gap-[4rem] items-center '>
    ...
    <form onSubmit={handleSubmit}  className='w-[100%]   flex justify-center '>
      <div className='flex gap-2 flex-col  py-4  md:w-[90%] w-[100%]'>
        ...
        <input type="password" name="password" id="password" placeholder='Enter password' required 
             className='w-[100%] px-4 py-3 text-[1rem] bg-white text-black rounded-md  outline-none border-none'
        
             onChange={(e)=>{handleChange(e)}}
        />
        </div>
        <button className='bg-gray-400 py-2 text-black w-[100%] rounded-md cursor-pointer' >
    {"Sign In"}
